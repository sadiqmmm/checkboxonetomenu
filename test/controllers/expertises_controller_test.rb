...
class ExpertisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expertise" do
    assert_difference('Expertise.count') do
      post expertises_url, params: { expertise: { name: @expertise.name, professor_id: @expertise.professor_id } }
    end
  ...
  test "should update expertise" do
    patch expertise_url(@expertise), params: { expertise: { name: @expertise.name, professor_id: @expertise.professor_id } }
